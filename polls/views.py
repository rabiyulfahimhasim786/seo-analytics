...
from .forms import DocumentForm, SitemapForm, StatuscodeForm, ExpirydataForm, SitemapxmlForm
...
def expirycsv(request):
    ...
    for obj in edocuments:
        ...
        #print(rank)
    #print(rank)
    with open('/var/www/ssl/site'+rank, encoding='utf-8-sig') as datafile:
...
def main(sitemaps):
    ...
    for sitemap in sitemaps:
        ...
        report_path = Path(f"{dot}/media/csv/data.csv")
